...
import { Plus, MessageSquare, Trash2, Bot, Settings, Zap, LayoutDashboard, Activity, Sun, Moon, Play, CalendarClock, Webhook, GitBranch, Menu, X, DollarSign, Wrench, Send } from "lucide-react";
